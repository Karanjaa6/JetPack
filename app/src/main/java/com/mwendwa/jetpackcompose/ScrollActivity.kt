        ...
        setContent {
            JETPACKCOMPOSETheme {
                ...
                Surface(
                  ...
                  val students = listOf("Ducky","Top Dawg","Rashad"
                      ,"Schoolboy Q","Sza","Zacari","Sampha",
                      "Baby Keem","Jermain","Mescudi","Ye","Tenuchi"
                      ,"Lil Keem","Curtis","Rza","Method Man"
                      ,"Ghostface","Deck")
...
fun DashboardScreen(students:List<String>){
    Box (modifier = Modifier.fillMaxSize()){
        Image(painter = painterResource(id = R.drawable.woo), contentDescription = "Background Image",
